...
try:
    ...
    # Import dynamic để tránh lỗi circular import nếu có
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://localhost:3000", "*"], # Thêm * cho dễ dev
...
class RAGRequest(BaseModel):
    ...
    model: Optional[str] = Field(None, description="Ollama model (e.g., llama3)")

    # Sửa validator cũ thành field_validator (Pydantic V2)
